...
public class ExcaliburTimeDisplay extends AbstractFeatureWidget {
    ...
    public void render(DrawContext context, MinecraftClient client) {
        ...
        drawText(client, context, 0, Text.translatable("elements-utils.display.excaliburTime.title").formatted(Formatting.UNDERLINE));
        String nextUser = data.getNextUser();
        drawText(client, context, 1, Text.literal("")
        ...
        drawText(client, context, 2, Text.literal("")
    ...
    private Text toRelativeTime(Duration duration) {
     ...
     * input is null.
     */
    private ZonedDateTime calculateTargetTime(ZonedDateTime startTime) {
    ...
    private void drawText(MinecraftClient client, DrawContext context, int line, Text text) {
